...
let topContentText1 = document.querySelector(
  ".main-content .top-content div:nth-child(1) p"
);
topContentText1.textContent = siteContent["main-content"]["features-content"];

let topContent2 = document.querySelector(
  ".main-content .top-content div:nth-child(2) h4"
);
topContent2.textContent = siteContent["main-content"]["about-h4"];
let topContentText2 = document.querySelector(
  ".main-content .top-content div:nth-child(2) p"
);
topContentText2.textContent = siteContent["main-content"]["about-content"];

//bottom container
let bottomContent1 = document.querySelector(
  ".main-content .bottom-content div:nth-child(1) h4"
);
bottomContent1.textContent = siteContent["main-content"]["services-h4"];
let bottomContentText1 = document.querySelector(
  ".main-content .bottom-content div:nth-child(1) p"
);
bottomContentText1.textContent =
  siteContent["main-content"]["services-content"];

let bottomContent2 = document.querySelector(
  ".main-content .bottom-content div:nth-child(2) h4"
);
bottomContent2.textContent = siteContent["main-content"]["product-h4"];
let bottomContentText2 = document.querySelector(
  ".main-content .bottom-content div:nth-child(2) p"
);
bottomContentText2.textContent = siteContent["main-content"]["product-content"];

let bottomContent3 = document.querySelector(
  ".main-content .bottom-content div:nth-child(3) h4"
);
bottomContent3.textContent = siteContent["main-content"]["vision-h4"];
let bottomContentText3 = document.querySelector(
  ".main-content .bottom-content div:nth-child(3) p"
);
...
contactInfoAddress.style.display = "flex";
contactInfoAddress.style.justifyContent = "center";

let contactInfoPhone = document.querySelector(".contact p:nth-child(3)");
contactInfoPhone.textContent = siteContent["contact"]["phone"];
contactInfoPhone.style.display = "flex";
contactInfoPhone.style.justifyContent = "center";

let contactInfoEmail = document.querySelector(".contact p:nth-child(4)");
contactInfoEmail.textContent = siteContent["contact"]["email"];
contactInfoEmail.style.display = "flex";
contactInfoEmail.style.justifyContent = "center";
